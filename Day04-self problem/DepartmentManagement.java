...
class DepartmentManagement {
    public static void main(String[] args) {
        ...
        company.getDepartment(0).addEmployee("Rajveer", "Developer");
        company.getDepartment(0).addEmployee("Darshan", "Tester");
        company.getDepartment(1).addEmployee("Aditya", "Manager");
